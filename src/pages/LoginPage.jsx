      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 sm:px-8">
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            />
            {errors.email && <p id="login-email-error" role="alert" className="text-[12px] text-[#f87171] mt-1.5 mb-3">{errors.email}</p>}

            <div className="flex items-center justify-between mb-[7px]">
              <label htmlFor="login-password" className="text-[12.5px] font-[560] text-[#d4d4d4]">Password</label>
              <Link to="/forgot-password" className="link text-[12px] font-medium">
                Forgot password?
              </Link>
            </div>
            <input
            ...
            />
            {errors.password && <p id="login-password-error" role="alert" className="text-[12px] text-[#f87171] mt-1.5 mb-3">{errors.password}</p>}
